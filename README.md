...
1. [Releases](https://github.com/milv0/QuickAccess/releases/latest)에서 `QuickAccess.dmg` 다운로드
2. DMG 열기
3. `QuickAccess.app`을 Applications 폴더에 드래그 (또는 바로 실행)
4. "확인되지 않은 개발자" 경고 시 → 우클릭 → 열기 → 열기
