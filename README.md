...
- **Keep Mac Awake** — Menu bar sessions (30m to 12h) that keep the display awake; auto-released on expiry or quit
...
Scripts/release.sh 1.3.6 --publish
```
